...
- [x] Separately built `ahtraces` companion included by npm postinstall, Homebrew, installers, and release archives
...
- [x] Shell completion scripts generated from the live CLI command tree (bash, zsh, fish), including `autohand`, `autohand-code`, `agent`, and `ah`
