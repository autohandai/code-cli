...
दूरस्थ फ़ाइल नाम केवल सक्षम सिंक श्रेणियों के भीतर सापेक्ष POSIX पाथ के रूप में स्वीकार किए जाते हैं। सिंक डायरेक्टरी ट्रैवर्सल, एब्सोल्यूट या Windows-शैली के पाथ, डुप्लिकेट या खाली सेगमेंट और सिम्बॉलिक लिंक द्वारा सक्षम रूट के बाहर रीडायरेक्ट किए गए गंतव्यों को अस्वीकार करता है।

एप्लिकेशन लॉगिन टोकन `Authorization` हेडर में केवल उन ट्रांसफ़र URL को भेजा जाता है जिनका ऑरिजिन कॉन्फ़िगर किए गए सिंक API से मेल खाता है। क्रॉस-ऑरिजिन प्रीसाइन्ड HTTPS URL को यह टोकन कभी नहीं मिलता; असुरक्षित या विकृत क्रॉस-ऑरिजिन URL अस्वीकार किए जाते हैं।
...
| ---------- | ------------------------------ | --------------------------------- |
| `/`        | स्लैश कमांड्स                   | `/help`, `/model`, `/quit`, `/exit` |
...
| `--browser`                | ब्राउज़र इंटीग्रेशन सक्षम करें                                                                  |
| `--no-browser`             | ब्राउज़र इंटीग्रेशन अक्षम करें                                                                  |
