...
export const turkeyTheme: ThemeDefinition = {
  name: 'turkey',
  vars: {
    flagRed: '#e30a17',
    crescentWhite: '#f8f8f2',
    deepRed: '#8f0d12',
    pomegranate: '#c21f32',
    turquoise: '#2aa7a9',
    bosphorus: '#1f6f8b',
  ...
  colors: {
    ...
    userMessageText: 'crescentWhite',
    toolPendingBg: 'surface',
    toolSuccessBg: '#113032',
    toolErrorBg: '#3a1115',
    toolTitle: 'flagRed',
    toolOutput: 'gray200',
    diffAdded: 'turquoise',
    ...
    syntaxKeyword: 'flagRed',
    syntaxFunction: 'turquoise',
    syntaxVariable: 'crescentWhite',
    syntaxString: 'gold',
    syntaxNumber: 'bosphorus',
    syntaxType: 'turquoise',
    syntaxOperator: 'pomegranate',
    syntaxPunctuation: 'gray300',
    mdHeading: 'flagRed',
    mdLink: 'turquoise',
    mdLinkUrl: 'gray400',
    ...
    mdQuote: 'crescentWhite',
    mdQuoteBorder: 'flagRed',
    mdHr: 'gray700',
    mdListBullet: 'flagRed',
  },
};

export const brazilTheme: ThemeDefinition = {
  name: 'brazil',
  vars: {
    brazilGreen: '#009b3a',
    brazilYellow: '#ffdf00',
  ...
  colors: {
    accent: 'brazilYellow',
    border: 'gray600',
    borderAccent: 'brazilGreen',
    borderMuted: 'gray700',
    success: 'leaf',
    error: '#e94b5f',
    warning: 'brazilYellow',
    muted: 'gray400',
    dim: 'gray100',
    text: 'warmWhite',
    userMessageBg: 'surfaceLight',
    ...
    toolPendingBg: 'surface',
    toolSuccessBg: '#12351f',
    toolErrorBg: '#38191d',
    toolTitle: 'brazilYellow',
    toolOutput: 'gray200',
    diffAdded: 'leaf',
    diffRemoved: '#ff6b7a',
    diffContext: 'gray400',
    syntaxComment: 'gray500',
    syntaxKeyword: 'brazilYellow',
    syntaxFunction: 'skyBlue',
    syntaxVariable: 'warmWhite',
    syntaxString: 'lime',
    syntaxNumber: 'brazilYellow',
    syntaxType: 'leaf',
    syntaxOperator: 'skyBlue',
    syntaxPunctuation: 'gray300',
    mdHeading: 'brazilYellow',
    mdLink: 'skyBlue',
    mdLinkUrl: 'gray400',
    mdCode: 'lime',
    mdCodeBlock: 'gray200',
    mdCodeBlockBorder: 'gray600',
    mdQuote: 'brazilYellow',
    mdQuoteBorder: 'brazilGreen',
    mdHr: 'gray700',
    mdListBullet: 'brazilYellow',
  },
};
