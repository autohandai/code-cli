...
export const FEATURE_REGISTRY: readonly FeatureDefinition[] = [
  ...
  },
  {
    ...
    label: 'Read state ledger',
    description: 'Record the exact file coverage shown to the model in the active session.',
    stage: 'experimental',
  ...
  {
    id: 'read_state_dedup',
    label: 'Read state dedup',
    description: 'Replace eligible repeated unchanged file reads with a consume-on-hit stub.',
    stage: 'experimental',
  ...
  },
  {
    ...
    description: 'Require a complete unchanged model-visible read before direct file mutations.',
    stage: 'experimental',
