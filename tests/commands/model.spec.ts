...
describe("API Key Validation", () => {
  ...
  describe("Error message formatting", () => {
    ...
    it("should provide helpful hints for 403 permission errors", () => {
      const hint =
        "Your API key may have restricted permissions or your account may need to add a payment method.";
    ...
    it("should provide helpful hints for 429 rate limit errors", () => {
      const hint =
        "You may have exceeded your API quota. Check your usage and billing settings.";
